...
import { fetchLawyerProfile, updateLawyerProfile } from '../../store/slices/lawyerSlice'
import { Loader2, Save, User } from 'lucide-react'

const profileSchema = z.object({
  full_name: z.string().min(1, 'Full name is required'),
  bar_registration_number: z.string().min(1, 'Bar registration number is required'),
  specialization: z.array(z.string()).min(1, 'At least one specialization is required'),
  court_practice: z.array(z.string()).optional(),
  ...
  years_experience: z.number().min(0, 'Experience must be a positive number'),
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                placeholder="Tell clients about your expertise, experience, and approach to law..."
                disabled={!isEditing}
                {...form.register('bio')}
              />
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <div className={`w-2 h-2 rounded-full ${
                  profile?.isComplete ? 'bg-green-500' : 'bg-yellow-500'
                }`} />
