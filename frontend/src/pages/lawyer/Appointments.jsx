...
import { fetchLawyerAppointments, updateAppointmentStatus } from '../../store/slices/lawyerSlice'
  ...
  const filteredAppointments = appointments
    .filter(appointment => {
      const matchesSearch = appointment.client_name?.toLowerCase().includes(searchTerm.toLowerCase()) ||
                           appointment.ClientProfile?.User?.email?.toLowerCase().includes(searchTerm.toLowerCase())
                    ...
                    <CardContent>
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm">{appointment.ClientProfile?.User?.email || 'N/A'}</span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Phone className="h-4 w-4 text-muted-foreground" />
                          <span className="text-sm">{appointment.ClientProfile?.phone || 'N/A'}</span>
                        </div>
                        <div className="flex items-center space-x-2">
