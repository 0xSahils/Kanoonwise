  ...
  const services = [
    {
      ...
      image: "[Image: Business registration documents and corporate seal]",
    ...
    },
    {
      ...
      image: "[Image: Legal documents and contract papers on desk]",
    ...
    },
    {
      ...
      image: "[Image: Trademark certificate and brand protection documents]",
              ...
              <div className="bg-gradient-to-br from-yellow-500/20 to-orange-500/20 rounded-2xl p-8 h-96 flex items-center justify-center border border-yellow-500/30">
                <div className="text-center text-yellow-400">
                  ...
                  <p className="text-sm opacity-75">
                    [Image: Legal professionals working on documents]
                  </p>
                </div>
              </div>
              {/* Floating Elements */}
